 ...
 * @cmd: Array of logic command strings
 * @input: user input received
 * @c:Shell Excution Time Case of Command Not Found
 * @argv: logic before program starts(argv[0] == Shell Program Name)
 * Return: 0 executed command 1 Case Command null -1 bad command
 */
