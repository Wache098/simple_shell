...
/**
 * struct _builtin - Defines struct which has built-in commands
 * with owned particular implementation functions
 * @command: - Built-in command
 * @function: - Points to custom functions that
 * posses similar functionalities as built-in commands
 */
