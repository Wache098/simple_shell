...
/**
 * help_alias - Displays infor on the shell by builtin command 'alias'
 */
...
/**
 * help_cd - Displays infor on the shell by builtin command 'cd'
 */
void help_cd(void)
{
...
/**
 * help_exit - Displays infor on the shell by builtin command 'exit'
 */
void help_exit(void)
{
...
/**
 * help_help - Displays infor on the shell by builtin command 'help'
 */
void help_help(void)
{
